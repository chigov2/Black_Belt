...
public class MinMax {
    public static void main(String[] args) {
        ...
        Student minStudent = students.stream().min((x,y)->x.getAge()-y.getAge()).get();
        System.out.println("min Student: "+minStudent);

        Student maxStudent = students.stream().max((x,y)->x.getAge()-y.getAge()).get();
